...
class ChangeLanguageView(TemplateView):
    template_name = 'changes/change_language.html'
...
class LogInView(GuestOnlyView, FormView):
    template_name = 'Accounts/log_in1.html'
...
class SignUpView(GuestOnlyView, FormView):
    template_name = 'Accounts/sign_up1.html'
...
class ActivateView(View):
    ...
    def get(request, code):
        ...
        return redirect('login_register:log_in1')
...
class ResendActivationCodeView(GuestOnlyView, FormView):
    ...
    def form_valid(self, form):
        ...
        return redirect('login_register:resend_activation_code')
...
class RestorePasswordView(GuestOnlyView, FormView):
    ...
    def form_valid(self, form):
        ...
        return redirect('login_register:restore_password_done')
...
class ChangeProfileView(LoginRequiredMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        return redirect('profile:change_profile')
...
class ChangeEmailView(LoginRequiredMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        return redirect('login_register:change_email')
...
class RemindUsernameView(GuestOnlyView, FormView):
    ...
    def form_valid(self, form):
        ...
        return redirect('login_register:remind_username')
...
class ChangePasswordView(BasePasswordChangeView):
    ...
    def form_valid(self, form):
        ...
        return redirect('login_register:change_password')
...
class LogOutView(LoginRequiredMixin, BaseLogoutView):
    template_name = 'Accounts/log_out1.html'
